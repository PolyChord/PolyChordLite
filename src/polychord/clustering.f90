            ...
            if(nlive>2) then 
                ...
                if(present(sub_dimensions)) then
                    similarity_matrix(:nlive,:nlive) =&
                        calculate_similarity_matrix(RTI%live(sub_dimensions,sel(nint(RTI%live(settings%c0,:))==i_cluster)), settings%wraparound(sub_dimensions))
                else 
                    similarity_matrix(:nlive,:nlive) =&
                        calculate_similarity_matrix(RTI%live(settings%h0:settings%h1,sel(nint(RTI%live(settings%c0,:))==i_cluster)), settings%wraparound)
                end if

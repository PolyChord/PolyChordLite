...
try:
    ...
    if str(e) == 'libchord.so: cannot open shared object file: No such file or directory':
        print('You need to configure your LD_LIBRARY_PATH to point to your PolyChord installation.')
...
if ld_preload and 'libmpi.so' not in os.environ['LD_PRELOAD']:
    print('You need to configure your LD_PRELOAD to point to your mpi installation.' )
    print('e.g. add this to your .bashrc:' )
    print('')
    print(ld_preload)
    sys.exit(1)
